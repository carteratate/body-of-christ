...
_COHERE_PER_SEARCH = 0.0025  # per API call (rerank-v4.0-pro: $2.50/1K searches)
...
class CostTracker:
    ...
    def record_cohere(self, step: str) -> None:
        self._breakdown[step] = self._breakdown.get(step, 0.0) + _COHERE_PER_SEARCH
